...
*/
	...
	class Mapping{
		...
		/*
		* Costructor: It takes input the path of the file TIMESTAMP_SEM.chk
		* 
		* @param string $path
		* @return
		...
		*/
		...
		/*
		* Controls if file is formatted correctly
		* 
		* @param array $array
		...
		*/
		...
		/*
		* Ordinated elements in the file
		* 
		* @param string $path
		* @return
		*
		*/
		...
		/*
		* Extracts the elements in the file and creates an array with this elements
		* 
		* @param string $path
		* @return array
		*
		...
		*/
		...
		/*
		* Creates arrays of keys. This keys are the codes of the products
		* 
		* @return array
		*
		*/
		...
		*/
		...
		/*
		* Creates array key => value with: 1) key is the code of product; the code of color of the product; the code of size of the product,
		* 2) value is the code of product; the code of color of the product; the code of size of the product
		* 
		* @return array
		*
		*/
		...
		/*
		* Creates array key => value with: 1) key is the code of product,
		* 2) value is the code of product; name of the product; model of the product; supplier of the product
		* 
		* @return array
		*
		*/
		...
		/*
		* Creates array key => value with: 1) key is the code of product,
		* 2) value is the price of the product; the flag of salable of the product
		* 
		* @return array
		*
		*/
		...
		/*
		* Creates array key => value with: 1) key is the code of product,
		* 2) value is the quantity of the product; the minimal quantity of the product
		* 
		* @return array
		*
		*/
		...
		/*
		* Creates array key => value with: 1) key is the code of product,
		* 2) value is the code of product; the code of the color of product
		* 
		* @return array
		*
		*/
		...
		/*
		* Creates array key => value with: 1) key is the code of product,
		* 2) value is an array key => value with: a) key is the duple code product and code color,
		* b) value is the name of the photo of the product
		* 
		* @return array
		*
		*/
		...
		/*
		* Creates string with code of the color: name of the color
		* 
		...
		*/
		...
		/*
		* Creates string with name of the photo
		* 
		* @param string $cod_size
		* @return string
		*
		*/
		...
		/*
		* Creates array key => value with: 1) key is the duple,
		* 2) value is the arrays of triple with array of attributes
		* 
		* @see $this->getColors
		* @see $this->getSizes
		* @see $this->getImages
		...
		*/
		...
		/*
		* Creates array Mapping with key = codes of the products
		* 
		...
		*/
		...
		/*
		* Creates array Combinations with key = triple
		* 
